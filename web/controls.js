...
function shellKeys(e){
 ...
 if(e.code==='Escape'){e.preventDefault();e.stopImmediatePropagation();openView('menu');}
 else if(e.code==='KeyH'||e.key==='?'){e.preventDefault();openView('controls');}
